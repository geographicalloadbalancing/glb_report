...
\begin{frame}{Our approach: Geographical Load Balancing}
	% Talk about how a request could be routed either to the nearest DC, or to the one that has available green energy. Explain concept of GLB 
	\begin{figure}
...
\begin{frame}{Our approach: Geographical Load Balancing}
	% Talk about how a request could be routed either to the nearest DC, or to the one that has available green energy. Explain concept of GLB 
	\begin{figure}
		\caption{\textbf{\textcolor{dgreen}{GLB}}: trade off latency with green energy use; prefer routing to DCs that currently have renewables available}
		\centering
		\epsfig{file=svg/nearestrouting.pdf, height=2.3in}
	\end{figure}
\end{frame}
