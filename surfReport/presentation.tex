...
\begin{frame}{The problem}
	\begin{block}{Energy cost is important for DCs.}
	...
	\end{block}
	\begin{block}{Need for load balancing between DCs}
	...
	\end{block}
	\begin{block}{Load, energy availability, grid electricity prices, etc. are time-varying and stochastic.}
...
\begin{frame}{Previous work}
	\begin{block}{Geographical load balancing}
...
\begin{frame}{The availability of renewable energy}
...
\begin{block}{Cooling optimization}
...
\begin{block}{Benchmarks for comparison}
