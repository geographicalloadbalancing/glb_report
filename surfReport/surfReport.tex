...
\subsection{@@@}
@@@ Readhead: Add paragraph explaining what DCs are. Internet companies such as Google use data centers to service users’ requests (such as Google searches). Service Internet requests such as Google searches. Company that runs the system of DCs wants to minimize cost from purchasing electricity etc..
