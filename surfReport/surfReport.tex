...
\subsection{The problem}
	\subsubsection{Energy cost is important for DCs.}
		Internet companies such as Google use data centers (DCs) to service users’ requests (such as Google searches). Each data center contains the computer servers (including processors to calculate stuff and disks to store and retrieve user data) that service the requests, along with the infrastructure needed to support their operation (power supply, cooling, networking).
		@@@ number of data centers? Size of a data center.
		Google maintains on the order of one million servers across its data centers.[http://www.datacenterknowledge.com/archives/2011/08/01/report-google-uses-about-900000-servers/, koomey report]
		...
		\paragraph{Servers use energy to process requests}
			...
			In 2010, data centers' power usage was between 23 and 31 gigawatts, constituting approximately $1.3\%$ of world electrity consumption, and $2\%$ in the US. Their consumption is growing rapidly, having approximately doubled from 2000 to 2005, and increased by 30 to 50 percent through 2010. Google used approximately 220 megawatts during 2010. [http://www.koomey.com/post/8323374335 http://www.mediafire.com/file/zzqna34282frr2f/koomeydatacenterelectuse2011finalversion.pdf]
			Energy usage is often the largest contributor to cost for running a data center, so reducing it would save huge piles of money. Further, the pugging companies purchase "brown" energy off the grid, which causes pollution.
			
			@@@@
			http://www.techweekeurope.co.uk/news/data-centre-power-increase-cloud-95359 says 38 GW total in 2012.
			http://www.dcd-intelligence.com/Industry-Census/Energy-Demand-2011-12: "Total power consumption of around 31 GW. This amount if fully utilised would be sufficient to provide energy to all residential households in the United Kingdom, France or Italy

A projected rate of increase in energy consumption of 19% into 2012"
...
"In 2007 the entire information and communication technologies or ICT sector was estimated to be responsible for roughly 2% of global carbon emissions with data centers accounting for 14% of the ICT footprint.[42] The US EPA estimates that servers and data centers are responsible for up to 1.5% of the total US electricity consumption,[43] or roughly .5% of US GHG emissions,[44] for 2007."
http://en.wikipedia.org/wiki/Data_center#Energy_use

See http://www.energystar.gov/ia/partners/prod_development/downloads/EPA_Datacenter_Report_Congress_Final1.pdf
...
@@@ Readhead: Add paragraph explaining what DCs are. Company that runs the system of DCs wants to minimize cost from purchasing electricity etc..
@@@ Quote numbers. Statistics for how many DCs there are, how much it costs to cool them, etc.
