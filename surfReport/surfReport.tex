...
\begin{figure*}
\centering
\epsfig{file=visualization-bmp.pdf, width=6.8in}
\caption{Screenshot of the visualization, running in the Chromium web browser.}

The interactive visualization can be viewed at \url{http://geographicalloadbalancing.github.com/svgmap.xhtml}.
\end{figure*}
