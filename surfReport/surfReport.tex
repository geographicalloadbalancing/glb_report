...
\begin{figure*}
\centering
\epsfig{file=cost_comparison.pdf, width=0.5\textwidth}
\caption{Comparison of optimal costs under Cooling-aware GLB, Cooling-oblivious GLB, and LOCAL, with varying renewable energy availability.}
...
\begin{figure}
\centering
\epsfig{file=carbon_summer.pdf, width=0.5\textwidth}
...
\begin{figure*}
	...
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\epsfig{file=cost_storage.pdf, width=\textwidth}
		\caption{Cost}
	...
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\epsfig{file=brown_storage.pdf, width=\textwidth}
