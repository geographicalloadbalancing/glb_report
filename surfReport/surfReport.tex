...
\subsection{The problem}
	\subsubsection{Energy cost is important for DCs.}
		...
		Google maintains on the order of one million servers across its data centers.[http://www.datacenterknowledge.com/archives/2011/08/01/report-google-uses-about-900000-servers/]
		...
		\paragraph{Servers use energy to process requests}
			...
			Energy usage is often the largest contributor to cost for running a data center.
			@@@ percent of US, world electricity use?
