...
\subsection{The problem}
	\subsubsection{Energy cost is important for DCs.}
		...
		Google maintains on the order of one million servers across its data centers\cite{google900000}\cite{koomeyreport} across at least 17 data centers\cite{googlenumdcs}.
		...
		\paragraph{Servers use energy to process requests}
			...
			In 2010, data centers' power usage was between 23 and 31 gigawatts\footnote{Other estimates: 38 GW in 2012\cite{dc38GW}; "Total power consumption of around 31 GW.[...]A projected rate of increase in energy consumption of 19\% into 2012"\cite{dcd:energydemand}}, constituting approximately $1.3\%$ of world electrity consumption, and $2\%$ in the US. Their consumption is growing rapidly, having approximately doubled from 2000 to 2005, and increased by 30 to 50 percent through 2010. Google used approximately 220 megawatts during 2010.\cite{koomeyreport}
